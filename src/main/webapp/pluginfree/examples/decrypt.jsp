...
/*
try {
    InitechTransferImpl transfer = new InitechTransferImpl(request);
    String val1 = transfer.get("cardNo1");
    System.out.println(val1);
    InitechTransferImpl t1 = new InitechTransferImpl(val1);
    System.out.println(t1.get());

    String val2 = transfer.get("cardNo2");
    System.out.println(val2);
    InitechTransferImpl t2 = new InitechTransferImpl(val2);
    System.out.println(t2.get());

    String val3 = transfer.get("cardNo3");
    System.out.println(val3);
    InitechTransferImpl t3 = new InitechTransferImpl(val3);
    System.out.println(t3.get());

    String val4 = transfer.get("cardNo4");
    System.out.println(val4);
    InitechTransferImpl t4 = new InitechTransferImpl(val4);
    System.out.println(t4.get());

    String val5 = transfer.get("E2E_TEXT_1");
    System.out.println(val5);
    InitechTransferImpl t5 = new InitechTransferImpl(val5);
    System.out.println(t5.get());

    String val6 = transfer.get("E2E_PASS_1");
    System.out.println(val6);
    InitechTransferImpl t6 = new InitechTransferImpl(val6);
...
//	for(String parameter : parameters.keySet()) {
	...
	for(String parameter : list) {
		...
		if(parameter.endsWith("__E2E__")){
			...
			out.print("<strong>");
			out.print("입력양식명 : " + plainkey +" : ");
			//out.println("전달받은값 : " + inputValue +"<br />");
			out.print("E2E복호화값 : " + inputValue +"<br />");
			out.print("E2E복호화방법 : " + PluginFree.findDecryptionMode(request, plainkey) +"<br />");
...
//	for(String parameter : parameters.keySet()) {
	for(String parameter : list) {
		...
		out.print("입력양식명 : " + parameter+ " => [" + value2 +"]");
		out.println("<br />");
	}
} else {
	Enumeration<String> enumeration = request.getParameterNames();
